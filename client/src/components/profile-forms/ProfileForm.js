		...
		() => {
			...
			if (!loading && profile) {
				...
				if (Array.isArray(profileData.expertise)) {
					profileData.expertise = profileData.expertise.join(', ');
				}
				if (Array.isArray(profileData.research_publications)) {
					profileData.research_publications = profileData.research_publications.join(
						', '
					);
				}
		...
		<Fragment>
			...
			<form className="form" onSubmit={onSubmit}>
				...
				<div className="form-group">
					...
					/>
					<small className="form-text">
						Could be your own organization or one you work for
					</small>
				</div>
				<div className="form-group">
					<input
